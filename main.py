...
def main():
    ...
    parser.add_argument(
        ...
        help="run modes: Training, Predict, Repeat, CV, Hyperparameter, Ensemble, Analysis,\
                            Bootstrap_Ensemble, Inductive_Conformal, Delta, Evidential"
    )
    parser.add_argument(
        "--job_name",
        default=None,
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="path of the folder to save UQ output files",
    )
    parser.add_argument(
        "--model_path",
        default=None,
    ...
    if args.out_folder != None:
        config["Job"]["out_folder"] = args.out_folder    
    if args.model != None:
    ...
    elif run_mode == "Bootstrap_Ensemble":
    ...
    # This writes the files as: '[model_path]/Neighbor_[Train/Val/Test]_[job_name].csv'
    elif run_mode == "Delta_Metric":

        print("Starting Delta Metric Model Training")
        print(
            "running for "
            + str(config["Models"]["epochs"])
            + " epochs"
    ...
    elif run_mode == "Inductive_Conformal":
